...
/**
 * @ORM\Table()
 * @ORM\Entity(repositoryClass="App\Repository\IslandPVEMetalRepository")
 * @ORM\HasLifecycleCallbacks()
 * @JMS\ExclusionPolicy("all")
 */
class IslandPVEMetal
{
    /**
     * @var \Doctrine\Common\Collections\Collection|Island[}
     * @ORM\ManyToMany(targetEntity="App\Entity\Island", mappedBy="pveMetals")
     */
    public $islands;
